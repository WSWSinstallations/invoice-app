...
def prepare_image_for_processing(original_path: Path, corrected_dir: Path) -> PreparedImage:
    ...
    try:
        with Image.open(original_path) as image:
            ...
            # IMPORTANT:
            # Do not force landscape images into portrait.
            # The old portrait_fallback rotated normal invoice photos by 90 degrees,
            # which caused OCR to read backwards/upside-down text.
            # If EXIF or Tesseract OSD cannot confidently detect rotation,
